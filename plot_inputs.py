...
# ---------- CARGA DATOS ----------
# UTM
dem_utm   = np.loadtxt("./input_data/dem_utm_km.dat")
sites_utm = np.loadtxt("./input_data/sites_utm_km.dat", ndmin=2)


# Maya / FEMTIC local
dem_maya   = np.loadtxt("./input_data/topography_for.dat")
sites_maya = np.loadtxt("./input_data/sites_coord_elev.dat", ndmin=2)
domain     = np.loadtxt("./input_data/analysis_domain.dat")
coast      = np.loadtxt("./input_data/coast_line_for.dat", skiprows=1)
